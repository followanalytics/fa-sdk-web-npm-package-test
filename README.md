## What
This is a simple application, created with `create-react-app` to show how to use the [FollowAnalytics Web SDK](https://www.npmjs.com/package/followanalytics) from [npm](https://www.npmjs.com/).

You can find the full documentation for the SDK in the [FollowAnalytics Developer Portal](http://dev.followanalytics.com/sdks/web/documentation/). 

## How to use:

### Using `npm`
Install all dependencies with `npm install`. Run with `npm start`.

### Using `yarn`
Install all dependencies with `yarn install`. Run with `yarn start`.
